...
public class Barcode implements Parcelable {
    ...
    public static final Parcelable.Creator CREATOR = new oss(15);
    ...
    public class Address implements Parcelable {
        public static final Parcelable.Creator CREATOR = new oss(16);
    ...
    public class BoardingPass implements Parcelable {
        public static final Parcelable.Creator CREATOR = new oss(17);
    ...
    public class CalendarDateTime implements Parcelable {
        public static final Parcelable.Creator CREATOR = new oss(18);
        public int day;
        public int hours;
    ...
    public class CalendarEvent implements Parcelable {
        public static final Parcelable.Creator CREATOR = new oss(19);
    ...
    public class ContactInfo implements Parcelable {
        public static final Parcelable.Creator CREATOR = new oss(20);
    ...
    public class DriverLicense implements Parcelable {
        public static final Parcelable.Creator CREATOR = new ouh(1);
    ...
    public class Email implements Parcelable {
        public static final Parcelable.Creator CREATOR = new ouh(0);
        public static final int HOME = 2;
        public static final int UNKNOWN = 0;
        public static final int WORK = 1;
    ...
    public class GeoPoint implements Parcelable {
        public static final Parcelable.Creator CREATOR = new ouh(3);
        public double lat;
        public double lng;
    ...
    public class PersonName implements Parcelable {
        public static final Parcelable.Creator CREATOR = new ouh(4);
        public String first;
    ...
    public class Phone implements Parcelable {
        public static final Parcelable.Creator CREATOR = new ouh(5);
    ...
    public class Sms implements Parcelable {
        public static final Parcelable.Creator CREATOR = new ouh(6);
    ...
    public class WiFi implements Parcelable {
        public static final Parcelable.Creator CREATOR = new ouh(8);
