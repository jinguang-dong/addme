...
public class Earth extends TrackableBase {
    ...
    public enum EarthState {
        ...
        static EarthState forNumber(int i) {
            ...
            throw new FatalException(a.bv(i, "Unexpected value for native EarthState, value="));
        }
    }
    ...
    public enum LocalizationPerformanceMode {
        ...
        static LocalizationPerformanceMode forNumber(int i) {
            ...
            throw new FatalException(a.bv(i, "Unexpected value for native LocalizationPerformanceMode, value="));
        }
    }
    ...
    public ResolveAnchorOnRooftopFuture resolveAnchorOnRooftopAsync(double d, double d2, double d3, float f, float f2, float f3, float f4, BiConsumer biConsumer) {
        long[] jArrNativeResolveAnchorOnRooftopAsync = nativeResolveAnchorOnRooftopAsync(this.session.nativeWrapperHandle, this.nativeHandle, d, d2, d3, f, f2, f3, f4, biConsumer != null ? new ResolveAnchorOnRooftopFuture.CallbackWrapper(this.session, biConsumer) : null);
    ...
    public ResolveAnchorOnTerrainFuture resolveAnchorOnTerrainAsync(double d, double d2, double d3, float f, float f2, float f3, float f4, BiConsumer biConsumer) {
        long[] jArrNativeResolveAnchorOnTerrainAsync = nativeResolveAnchorOnTerrainAsync(this.session.nativeWrapperHandle, this.nativeHandle, d, d2, d3, f, f2, f3, f4, biConsumer != null ? new ResolveAnchorOnTerrainFuture.CallbackWrapper(this.session, biConsumer) : null);
