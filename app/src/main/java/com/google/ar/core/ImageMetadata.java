...
public class ImageMetadata {
    ...
    private void getMetdataEntry(int i, rtm rtmVar) {
        ...
        rtmVar.b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, jNativeGetMetadataEntry);
        rtmVar.c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, rtmVar.a);
    }
    ...
    public byte getByte(int i) {
        ...
        rtm rtmVar = this.sketchEntry;
        if (rtmVar.b != 0 || rtmVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        byte bNativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
    ...
    public byte[] getByteArray(int i) {
        ...
        byte[] bArrNativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        rtm rtmVar = this.sketchEntry;
        if (rtmVar.b != 4 || rtmVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        double dNativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public double[] getDoubleArray(int i) {
        ...
        double[] dArrNativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        rtm rtmVar = this.sketchEntry;
        if (rtmVar.b != 2 || rtmVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        float fNativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public float[] getFloatArray(int i) {
        ...
        float[] fArrNativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public int getInt(int i) {
        getMetdataEntry(i, this.sketchEntry);
        rtm rtmVar = this.sketchEntry;
        if (rtmVar.b != 1 || rtmVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        int iNativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public int[] getIntArray(int i) {
        ...
        int[] iArrNativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public long getLong(int i) {
        ...
        long jNativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public long[] getLongArray(int i) {
        ...
        long[] jArrNativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        rtm rtmVar = this.sketchEntry;
        if (rtmVar.b != 5 || rtmVar.c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i)));
        }
        Rational rationalNativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public Rational[] getRationalArray(int i) {
        ...
        Rational[] rationalArrNativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, rtmVar.a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
