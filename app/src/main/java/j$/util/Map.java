...
public interface Map<K, V> {
    ...
    public final /* synthetic */ class EL {
        ...
        public static void b(java.util.Map map, BiFunction biFunction) {
            if (map instanceof Map) {
            ...
            ConcurrentMap concurrentMap = (ConcurrentMap) map;
            biFunction.getClass();
            j$.nio.file.C c = new j$.nio.file.C(1, concurrentMap, biFunction);
            if (concurrentMap instanceof j$.util.concurrent.v) {
                ((j$.util.concurrent.v) concurrentMap).forEach(c);
            } else {
                j$.desugar.sun.nio.fs.g.g(concurrentMap, c);
            }
        }
        ...
        public static /* synthetic */ void forEach(java.util.Map map, BiConsumer biConsumer) {
            if (map instanceof Map) {
                ...
                j$.desugar.sun.nio.fs.g.g((ConcurrentMap) map, biConsumer);
            } else {
