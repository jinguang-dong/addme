...
public class C1 extends AbstractC0053c implements Consumer, Iterable, j$.lang.a {
    ...
    public Spliterator spliterator() {
        return new C0105t1(this, 0, this.b, 0, this.a);
    }

    public final String toString() {
        ArrayList arrayList = new ArrayList();
        forEach(new j$.desugar.sun.nio.fs.h(14, arrayList));
