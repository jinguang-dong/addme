...
public final class C extends AbstractC0020d {
    ...
    public final long D(j$.time.temporal.l lVar) {
        ...
        int i = B.a[((j$.time.temporal.a) lVar).ordinal()];
        if (i == 4) {
            int iV = V();
            if (iV < 1) {
                iV = 1 - iV;
    ...
    public final InterfaceC0018b k(TemporalAdjuster temporalAdjuster) {
        return (C) super.k(temporalAdjuster);
    }
    ...
    */
    public final j$.time.chrono.C a(long r9, j$.time.temporal.l r11) {
        /*
            r8 = this;
        ...
        L98:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.C.a(long, j$.time.temporal.l):j$.time.chrono.C");
    }

    public final C X(j$.time.h hVar) {
    ...
    public final j$.time.temporal.o l(j$.time.temporal.l lVar) {
        ...
        return j$.time.temporal.o.f(1L, V() <= 0 ? (-oVar.a) + 1912 : oVar.d - 1911);
    }

    @Override // j$.time.chrono.AbstractC0020d, j$.time.chrono.InterfaceC0018b
    public final InterfaceC0018b x(long j, TemporalUnit temporalUnit) {
        return (C) super.x(j, temporalUnit);
    }
