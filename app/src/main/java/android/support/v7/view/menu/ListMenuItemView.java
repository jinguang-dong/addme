...
public class ListMenuItemView extends LinearLayout implements AbsListView.SelectionBoundsAdjuster, gn {
    public gd a;
    public ImageView b;
    public boolean c;
    public boolean d;
    ...
    /* JADX WARN: Type inference failed for: r11v0, types: [android.support.v7.view.menu.ListMenuItemView, android.view.ViewGroup, gn] */
    ...
    public final void f(gd gdVar) {
        ...
        CharSequence charSequenceF = gdVar.f(this);
        ...
        if (i == 0) {
            ...
            if (cE == 0) {
                ...
                gb gbVar = gdVar2.j;
                Context context = gbVar.a;
                Resources resources = context.getResources();
                StringBuilder sb = new StringBuilder();
                if (ViewConfiguration.get(context).hasPermanentMenuKey()) {
                    sb.append(resources.getString(R.string.abc_prepend_shortcut_label));
                }
                int i2 = gbVar.x() ? gdVar2.i : gdVar2.g;
                gd.g(sb, i2, ImageMetadata.CONTROL_AE_ANTIBANDING_MODE, resources.getString(R.string.abc_menu_meta_shortcut_label));
                gd.g(sb, i2, 4096, resources.getString(R.string.abc_menu_ctrl_shortcut_label));
                gd.g(sb, i2, 2, resources.getString(R.string.abc_menu_alt_shortcut_label));
                gd.g(sb, i2, 1, resources.getString(R.string.abc_menu_shift_shortcut_label));
                gd.g(sb, i2, 4, resources.getString(R.string.abc_menu_sym_shortcut_label));
                gd.g(sb, i2, 8, resources.getString(R.string.abc_menu_function_shortcut_label));
                if (cE == '\b') {
        ...
        boolean zHasSubMenu = gdVar.hasSubMenu();
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        pmg pmgVarJ = pmg.J(getContext(), attributeSet, fa.r, i, 0);
        this.m = pmgVarJ.z(5);
        this.n = pmgVarJ.x(1, -1);
        this.c = pmgVarJ.E(7, false);
        this.o = context;
        this.p = pmgVarJ.z(8);
