...
public class ScriptIntrinsicColorMatrix extends ScriptIntrinsic {
    ...
    private void setMatrix() throws Throwable {
    ...
    public void setAdd(float f, float f2, float f3, float f4) throws Throwable {
    ...
    public void setColorMatrix(Matrix3f matrix3f) throws Throwable {
        this.mMatrix.load(matrix3f);
        setMatrix();
    }

    public void setGreyscale() throws Throwable {
    ...
    public void setRGBtoYUV() throws Throwable {
        this.mMatrix.loadIdentity();
        this.mMatrix.set(0, 0, 0.299f);
        this.mMatrix.set(1, 0, 0.587f);
        this.mMatrix.set(2, 0, 0.114f);
    ...
    public void setYUVtoRGB() throws Throwable {
        this.mMatrix.loadIdentity();
    ...
    public void setColorMatrix(Matrix4f matrix4f) throws Throwable {
        this.mMatrix.load(matrix4f);
        setMatrix();
    }

    public void setAdd(Float4 float4) throws Throwable {
