...
public final class gxm extends gxl {
    ...
    static {
        ...
        gsn.t(tpcVarM);
        Float fValueOf = Float.valueOf(0.600913f);
        ...
        gsn.x(1.5f, tpcVarM3);
        gsn.t(tpcVarM3);
        Float fValueOf7 = Float.valueOf(1.5f);
        Float fValueOf8 = Float.valueOf(3.0f);
        ...
        tpcVarM4.v(sbpVarN4);
        gsn.s(tpcVarM4);
        Float fValueOf9 = Float.valueOf(5.0f);
        sbp sbpVarO2 = sbp.o(fValueOf, fValueOf2, fValueOf3, fValueOf9);
        sbpVarO2.getClass();
        tpcVarM4.u(sbpVarO2);
        ...
        tpcVarM5.v(sbpVarN5);
        gsn.s(tpcVarM5);
        sbp sbpVarO3 = sbp.o(fValueOf, fValueOf2, fValueOf3, fValueOf8);
        sbpVarO3.getClass();
        tpcVarM5.u(sbpVarO3);
        ...
        tpcVarM6.v(sbpVarN6);
        gsn.s(tpcVarM6);
        sbp sbpVarO4 = sbp.o(fValueOf, fValueOf2, fValueOf3, fValueOf9);
        sbpVarO4.getClass();
        tpcVarM6.u(sbpVarO4);
        ...
        tpcVarM7.v(sbpVarM3);
        gsn.s(tpcVarM7);
        sbp sbpVarN7 = sbp.n(fValueOf2, fValueOf3, fValueOf8);
        sbpVarN7.getClass();
        tpcVarM7.u(sbpVarN7);
        ...
        gsn.v(1.2f, tpcVarM8);
        gsn.t(tpcVarM8);
        Float fValueOf10 = Float.valueOf(1.2f);
        sbp sbpVarM4 = sbp.m(fValueOf2, fValueOf10);
        sbpVarM4.getClass();
        tpcVarM8.v(sbpVarM4);
        gsn.s(tpcVarM8);
        sbp sbpVarN8 = sbp.n(fValueOf2, fValueOf10, fValueOf6);
        sbpVarN8.getClass();
        tpcVarM8.u(sbpVarN8);
