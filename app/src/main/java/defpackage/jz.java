...
public class jz implements gq {
    ...
    public jh p(Context context, boolean z) {
    ...
    public final void s() {
        ...
        if (this.e == null) {
            jh jhVarP = p(this.a, !this.p);
            this.e = jhVarP;
            jhVarP.setAdapter(this.b);
            this.e.setOnItemClickListener(this.m);
            this.e.setFocusable(true);
            this.e.setFocusableInTouchMode(true);
            this.e.setOnItemSelectedListener(new daa(this, 1));
    ...
    public jz(Context context, AttributeSet attributeSet, int i, byte[] bArr) {
        this.c = -2;
        this.f = -2;
        this.s = 1002;
        this.j = 0;
        this.k = Integer.MAX_VALUE;
        this.r = new av(this, 19, null);
        this.y = new fuo(this, 1);
        this.v = new jy(this);
        this.z = new av(this, 18, null);
        this.w = new Rect();
        this.a = context;
        this.o = new Handler(context.getMainLooper());
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, fa.o, i, 0);
        ...
        hv hvVar = new hv(context, attributeSet, i);
        this.q = hvVar;
        hvVar.setInputMethodMode(1);
    }
}
