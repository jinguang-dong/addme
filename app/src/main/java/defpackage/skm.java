...
public enum skm {
    ...
    static {
        ...
        for (skm skmVar : values()) {
            if (map.put(Character.valueOf(skmVar.G), skmVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(skmVar))));
            }
        }
