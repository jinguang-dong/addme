...
public class ho extends CheckBox {
    public final hq a;
    private final hn b;
    private final in c;
    private byz d;
    ...
    public ho(Context context, AttributeSet attributeSet) {
        ...
        this.b = hnVar;
        hnVar.b(attributeSet, R.attr.checkboxStyle);
        in inVar = new in(this);
        this.c = inVar;
        inVar.c(attributeSet, R.attr.checkboxStyle);
        a().G(attributeSet, R.attr.checkboxStyle);
    }
