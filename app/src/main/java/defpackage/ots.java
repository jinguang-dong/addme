...
public final class ots {
    ...
    public static ots a(Context context) {
    ...
    public final boolean b() {
        PackageInfo packageInfoI;
        boolean zC;
        try {
            packageInfoI = ojo.b(this.d).i("com.google.android.wearable.app.cn", 64);
        } catch (PackageManager.NameNotFoundException unused) {
            packageInfoI = null;
        }
        if (packageInfoI != null) {
            if (oef.b(this.d)) {
                zC = c(packageInfoI, true);
            } else {
                zC = c(packageInfoI, false);
                if (!zC && c(packageInfoI, true)) {
