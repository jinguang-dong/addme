...
public final class dek {
    ...
    */
    public dek(java.lang.String r1, java.lang.String r2, boolean r3, int r4, java.lang.String r5, int r6) {
        /*
            r0 = this;
            r0.<init>()
            r0.a = r1
            ...
            boolean r2 = defpackage.ujp.t(r1, r2)
            if (r2 == 0) goto L22
            r1 = 3
            goto L63
        L22:
        ...
        L46:
            ...
            boolean r1 = defpackage.ujp.t(r1, r2)
            if (r1 == 0) goto L60
            goto L62
        L60:
            r1 = 1
        ...
        L63:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dek.<init>(java.lang.String, java.lang.String, boolean, int, java.lang.String, int):void");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        dek dekVar = (dek) obj;
        if (a() != dekVar.a() || !a.ao(this.a, dekVar.a) || this.c != dekVar.c) {
            return false;
        }
        String str = this.e;
        String str2 = dekVar.e;
        int i = this.f;
        if (i == 1 && dekVar.f == 2 && str != null && !cgh.r(str, str2)) {
            return false;
        }
        if (i == 2 && dekVar.f == 1 && str2 != null && !cgh.r(str2, str)) {
            return false;
        }
        if (i == dekVar.f) {
            if (str != null) {
