...
public final class dte extends Drawable {
    private static final Property b = new dtd(Integer.class);
    private static final TimeInterpolator c = dsu.a;
    ...
    public dte() {
        ...
        ObjectAnimator objectAnimatorOfInt = ObjectAnimator.ofInt(this, (Property<dte, Integer>) b, 0, 10000);
