...
public class rlc extends LinearLayoutCompat {
    protected boolean a;
    boolean b;
    private Drawable c;
    ...
    public rlc(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public rlc(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray typedArrayA = rlg.a(context, attributeSet, rle.a, i, 0, new int[0]);
