...
public final class dnb implements bfx, bfs {
    public final zw a;
    private final bfx b;
    private final bfs c;

    public dnb(bfx bfxVar, Map map, bfs bfsVar) {
        this.b = new bfy(map, new dlz(bfxVar, 4));
        this.c = bfsVar;
        int i = zx.a;
    ...
    */
    public final java.util.Map b() {
        ...
        L47:
            ...
            return r15
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dnb.b():java.util.Map");
    }
    ...
    public final void c(Object obj, uiu uiuVar, ayc aycVar, int i) {
        int i2;
        int i3 = i & 6;
        ayc aycVarC = aycVar.c(-469731029);
        if (i3 == 0) {
        ...
        if (baiVarI != null) {
            baiVarI.d = new apc(this, obj, uiuVar, i, 7);
        }
    }
