...
public final class gxk extends gxl {
    ...
    static {
        ...
        gsn.t(tpcVarM);
        Float fValueOf = Float.valueOf(0.530602f);
        ...
        gsn.v(1.7214f, tpcVarM3);
        gsn.t(tpcVarM3);
        Float fValueOf6 = Float.valueOf(1.7214f);
        sbp sbpVarM2 = sbp.m(fValueOf6, fValueOf3);
        sbpVarM2.getClass();
        tpcVarM3.v(sbpVarM2);
        gsn.s(tpcVarM3);
        Float fValueOf7 = Float.valueOf(3.0f);
        sbp sbpVarN3 = sbp.n(fValueOf6, fValueOf3, fValueOf7);
        sbpVarN3.getClass();
        tpcVarM3.u(sbpVarN3);
        ...
        sbp sbpVarO2 = sbp.o(fValueOf, fValueOf2, fValueOf3, fValueOf8);
        sbpVarO2.getClass();
        tpcVarM4.u(sbpVarO2);
        ...
        tpcVarM6.v(sbpVarN6);
        gsn.s(tpcVarM6);
        sbp sbpVarO4 = sbp.o(fValueOf, fValueOf2, fValueOf3, fValueOf8);
        sbpVarO4.getClass();
        tpcVarM6.u(sbpVarO4);
        tpc tpcVarM7 = gyd.a.m();
        tpcVarM7.getClass();
        gsn.w(gyb.FACING_BACK, tpcVarM7);
        ...
        tpcVarM7.v(sbpVarM3);
        gsn.s(tpcVarM7);
        sbp sbpVarN7 = sbp.n(fValueOf2, fValueOf3, fValueOf7);
        sbpVarN7.getClass();
        tpcVarM7.u(sbpVarN7);
        tpc tpcVarM8 = gyd.a.m();
        tpcVarM8.getClass();
        gsn.w(gyb.FACING_FRONT, tpcVarM8);
        gsn.u(ssc.PORTRAIT, tpcVarM8);
        gsn.v(1.2f, tpcVarM8);
        gsn.t(tpcVarM8);
        Float fValueOf9 = Float.valueOf(1.2f);
        sbp sbpVarM4 = sbp.m(fValueOf2, fValueOf9);
        sbpVarM4.getClass();
        tpcVarM8.v(sbpVarM4);
        gsn.s(tpcVarM8);
        sbp sbpVarN8 = sbp.n(fValueOf2, fValueOf9, fValueOf5);
        sbpVarN8.getClass();
        tpcVarM8.u(sbpVarN8);
        b = rnt.ae(new gyd[]{gsn.q(tpcVarM), gsn.q(tpcVarM2), gsn.q(tpcVarM3), gsn.q(tpcVarM4), gsn.q(tpcVarM5), gsn.q(tpcVarM6), gsn.q(tpcVarM7), gsn.q(tpcVarM8)});
    }
