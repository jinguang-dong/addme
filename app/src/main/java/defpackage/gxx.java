...
public final class gxx extends gxl {
    ...
    static {
        ...
        gsn.t(tpcVarM);
        Float fValueOf = Float.valueOf(0.54906833f);
        ...
        gsn.x(1.4f, tpcVarM7);
        gsn.t(tpcVarM7);
        sbp sbpVarM3 = sbp.m(fValueOf2, fValueOf4);
        sbpVarM3.getClass();
        tpcVarM7.v(sbpVarM3);
        gsn.s(tpcVarM7);
        sbp sbpVarN7 = sbp.n(fValueOf2, fValueOf4, fValueOf5);
        sbpVarN7.getClass();
        tpcVarM7.u(sbpVarN7);
        tpc tpcVarM8 = gyd.a.m();
        tpcVarM8.getClass();
        gsn.w(gyb.FACING_FRONT, tpcVarM8);
        gsn.u(ssc.NIGHT_SIGHT, tpcVarM8);
        gsn.v(1.4f, tpcVarM8);
        gsn.x(1.4f, tpcVarM8);
        gsn.t(tpcVarM8);
        ...
        gsn.u(ssc.MOTION_LANDSCAPE, tpcVarM9);
        gsn.v(1.4f, tpcVarM9);
        gsn.x(1.4f, tpcVarM9);
        gsn.t(tpcVarM9);
        ...
        gsn.u(ssc.MOTION_ACTION_PAN, tpcVarM10);
