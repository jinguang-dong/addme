...
public final class hog extends AnimatorListenerAdapter {
    final /* synthetic */ hnq a;
    final /* synthetic */ Context b;
    final /* synthetic */ Resources c;

    public hog(hnq hnqVar, Context context, Resources resources) {
        this.a = hnqVar;
        this.b = context;
        this.c = resources;
    }
    ...
    public final void onAnimationStart(Animator animator) {
        ...
        hnqVar.n(resources.getDimension(R.dimen.square_focus_ring_thickness));
