...
public final class lu {
    ...
    public lu(StaggeredGridLayoutManager staggeredGridLayoutManager, int i) {
        this.f = staggeredGridLayoutManager;
        this.e = i;
    }

    public static final lq n(View view) {
        return (lq) view.getLayoutParams();
    }
    ...
    public final View g(int i, int i2) {
        ...
        if (i2 != -1) {
            ...
            while (size >= 0) {
                ...
                if ((staggeredGridLayoutManager.d && StaggeredGridLayoutManager.bi(view2) >= i) || ((!staggeredGridLayoutManager.d && StaggeredGridLayoutManager.bi(view2) <= i) || !view2.hasFocusable())) {
                    break;
                }
                size--;
                view = view2;
        ...
        while (i3 < size2) {
            ...
            if ((staggeredGridLayoutManager2.d && StaggeredGridLayoutManager.bi(view3) <= i) || ((!staggeredGridLayoutManager2.d && StaggeredGridLayoutManager.bi(view3) >= i) || !view3.hasFocusable())) {
                break;
            }
            i3++;
            view = view3;
