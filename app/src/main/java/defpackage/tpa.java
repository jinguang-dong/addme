...
public final class tpa extends tnu implements RandomAccess, tpm, tqz {
    ...
    public final boolean addAll(Collection collection) {
        fG();
        tpx.b(collection);
        if (!(collection instanceof tpa)) {
            return super.addAll(collection);
        }
        tpa tpaVar = (tpa) collection;
        int i = tpaVar.c;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(tpaVar.b, 0, this.b, this.c, tpaVar.c);
        this.c = i3;
        this.modCount++;
        return true;
    }
    ...
    public final tpm e(int i) {
        if (i >= this.c) {
            return new tpa(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
    ...
    private tpa(float[] fArr, int i, boolean z) {
        super(z);
        this.b = fArr;
        this.c = i;
    }
