...
public final class svs {
    ...
    */
    public static long a(double r8, java.math.RoundingMode r10) {
        /*
            boolean r0 = defpackage.rkf.n(r8)
            if (r0 == 0) goto Lb8
            int[] r0 = defpackage.svr.a
            int r1 = r10.ordinal()
            r0 = r0[r1]
            r1 = 1
        ...
        Lb8:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.svs.a(double, java.math.RoundingMode):long");
    }
    ...
    public static boolean b(double d) {
        ...
        if (d != 0.0d) {
            rnt.B(rkf.n(d), "not a normal value");
