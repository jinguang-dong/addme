...
public final class jwc {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof jwc) {
            jwc jwcVar = (jwc) obj;
            if (this.a.equals(jwcVar.a) && this.b.equals(jwcVar.b) && this.c.equals(jwcVar.c) && this.d.equals(jwcVar.d)) {
                return true;
            }
        }
        return false;
    ...
    public jwc(Optional optional, Optional optional2, Optional optional3, Optional optional4) {
        this.a = optional;
        this.b = optional2;
        this.c = optional3;
        this.d = optional4;
