...
public final class tpi extends tnu implements RandomAccess, tpn, tqz {
    public static final tpi a;
    ...
    public final boolean addAll(Collection collection) {
        fG();
        tpx.b(collection);
        if (!(collection instanceof tpi)) {
            return super.addAll(collection);
        }
        tpi tpiVar = (tpi) collection;
        int i = tpiVar.c;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(tpiVar.b, 0, this.b, this.c, tpiVar.c);
        this.c = i3;
        this.modCount++;
        return true;
    }
    ...
    public final tpn e(int i) {
        if (i >= this.c) {
            return new tpi(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
    ...
    private tpi(int[] iArr, int i, boolean z) {
        super(z);
        this.b = iArr;
        this.c = i;
    }
