...
public final class gp extends fs implements Menu {
    private final cmm c;

    public gp(Context context, cmm cmmVar) {
        super(context);
        this.c = cmmVar;
    }
    ...
    public final void removeGroup(int i) {
        if (this.b != null) {
            ...
            while (true) {
                ...
                if (((cmn) aaaVar.d(i2)).getGroupId() == i) {
                    this.b.e(i2);
                    i2--;
                }
                i2++;
    ...
    public final void removeItem(int i) {
        if (this.b != null) {
            ...
            while (true) {
                ...
                if (((cmn) aaaVar.d(i2)).getItemId() == i) {
                    this.b.e(i2);
                    break;
                }
                i2++;
    ...
    public final MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return a(((gb) this.c).c(i, i2, i3, charSequence));
    }
