...
final class rzo extends rzr {
    private static final long serialVersionUID = 0;

    public rzo(Comparable comparable) {
        super(comparable);
    }
    ...
    public final rzr h(rzw rzwVar) {
        Comparable comparableD = rzwVar.d(this.b);
        return comparableD == null ? rzp.a : new rzq(comparableD);
    }
