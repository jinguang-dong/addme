...
public final class xv extends Drawable {
    public float a;
    public float b;
    ...
    public xv(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void a(Rect rect) {
        ...
        rect2.set(rect);
        if (this.c) {
            rect2.inset((int) Math.ceil(xw.a(this.b, this.a, this.d)), (int) Math.ceil(xw.b(this.b, this.a, this.d)));
            rectF.set(rect2);
        }
    }
