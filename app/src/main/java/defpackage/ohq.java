...
public final class ohq {
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return oji.e(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String e(Context context, String str) {
        ...
        aaa aaaVar = a;
        synchronized (aaaVar) {
            Locale locale = cmr.b(context.getResources().getConfiguration().getLocales()).b.a.get(0);
            if (!locale.equals(b)) {
                aaaVar.clear();
                b = locale;
            }
            String str2 = (String) aaaVar.get(str);
            if (str2 != null) {
                return str2;
            }
            int i = oef.c;
            ...
            if (identifier == 0) {
                Log.w("GoogleApiAvailability", mn.g(str, "Missing resource: "));
                return null;
            }
            String string = resourcesForApplication.getString(identifier);
            if (TextUtils.isEmpty(string)) {
                Log.w("GoogleApiAvailability", mn.g(str, "Got empty resource: "));
                return null;
            }
            a.put(str, string);
            return string;
    ...
    public static String c(Context context, int i) {
        ...
        switch (i) {
            ...
            case 7:
                ...
                return e(context, mNLbzhCxd.BiUYTjcJmPVam);
            case 8:
            ...
            case 19:
            default:
                Log.e("GoogleApiAvailability", a.bv(i, "Unexpected error code "));
                return null;
            case 16:
