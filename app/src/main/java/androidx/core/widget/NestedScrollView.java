...
public class NestedScrollView extends FrameLayout implements cnw, cnt {
    private static final float g = (float) (Math.log(0.78d) / Math.log(0.9d));
    private static final cqi h = new cqi();
    ...
    */
    ...
    private final boolean K(EdgeEffect edgeEffect, int i2) {
        ...
        float fA = cqh.a(edgeEffect) * getHeight();
    ...
    private final boolean L(MotionEvent motionEvent) {
        ...
        cqh.b(this.c, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    private final ejs O() {
        if (this.f == null) {
            this.f = new ejs((View) this, (byte[]) null);
        }
        return this.f;
    }
    ...
    */
    ...
    final int i(int i2, int i3, MotionEvent motionEvent, int i4, int i5, boolean z) {
        ...
        if (motionEvent == null || scrollY2 == 0) {
            ...
            i8 = 0;
            z2 = 1;
            O().o(motionEvent.getDeviceId(), motionEvent.getSource(), i3, scrollY2);
        }
        iArr[z2] = i8;
        ...
        if (i11 < 0) {
            if (z3) {
                cqh.b(this.b, (-i10) / getHeight(), i4 / getWidth());
                if (motionEvent != null) {
                    O().n(motionEvent.getDeviceId(), motionEvent.getSource(), i3, z2);
                }
                if (!this.c.isFinished()) {
                    this.c.onRelease();
                }
            ...
            cqh.b(this.c, i10 / getHeight(), 1.0f - (i4 / getWidth()));
            if (motionEvent != null) {
                O().n(motionEvent.getDeviceId(), motionEvent.getSource(), i3, i8);
            }
            if (!this.b.isFinished()) {
                this.b.onRelease();
            }
        ...
        if (!this.b.isFinished() || !this.c.isFinished()) {
            postInvalidateOnAnimation();
        } else if (z4 && i5 == 0 && (velocityTracker = this.r) != null) {
            velocityTracker.clear();
        }
        if (i5 == 1) {
            k(1);
    ...
    public final void j(int i2) {
        if (getChildCount() > 0) {
            ...
            E(true);
            cpn.b(this, Math.abs(this.a.getCurrVelocity()));
        }
    }
    ...
    public final boolean o(int i2) {
        ...
        return J(i2, rect.top, rect.bottom);
    }
    ...
    public final boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.q) {
            if (coi.C(motionEvent, 2)) {
                axisValue = motionEvent.getAxisValue(9);
                i2 = 9;
                width = (int) motionEvent.getX();
            } else if (coi.C(motionEvent, 4194304)) {
            ...
            if (axisValue != 0.0f) {
                i(-((int) (axisValue * a())), i2, motionEvent, width, 1, coi.C(motionEvent, 8194));
    ...
    */
    ...
    protected final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        cqk cqkVar = (cqk) parcelable;
        super.onRestoreInstanceState(cqkVar.getSuperState());
        this.C = cqkVar;
        requestLayout();
    }
    ...
    protected final Parcelable onSaveInstanceState() {
        cqk cqkVar = new cqk(super.onSaveInstanceState());
        cqkVar.a = getScrollY();
        return cqkVar;
    }
    ...
    */
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.google.ar.core.R.attr.nestedScrollViewStyle);
    }
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.y = new int[2];
        this.z = new int[2];
        cqj cqjVar = new cqj(this, 0);
        this.d = cqjVar;
        this.e = new cno(getContext(), cqjVar);
        this.b = cqh.c(context, attributeSet);
        this.c = cqh.c(context, attributeSet);
